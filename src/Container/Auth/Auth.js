            ...
            <div className="container">
                {
                    password ?
                        <div className="section-title">
                            <h2 className='centeerr'>reset password</h2>
                        </div>
                        : usertype === 'Login' ?
                            <div classname="section-title">
                ...
                <div action method="post" className="php-email-form">
                    <div className="row">
                        {
                            password ? <div className="col-md-12 form-group mt-3 mt-md-0">
                    ...
                    {
                        password ? <div className='text-center'><button onClick={() => setpassword('password')}>Forget password</button></div> :
                        usertype === 'Login' ?
